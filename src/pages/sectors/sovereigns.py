...
dash.register_page(__name__, path='/sectors/sovereigns')
...
# display sector
@callback(
    [Output('sector2-description', 'children'),
     Output({'type': 'sector2-btn', 'index': ALL}, 'active')],
    Input({'type': 'sector2-btn', 'index': ALL}, 'n_clicks'),
    State('yml-store', 'data'),
    prevent_initial_call=True
)
def display_sector2(n_clicks, yml_data):
    # load yml
